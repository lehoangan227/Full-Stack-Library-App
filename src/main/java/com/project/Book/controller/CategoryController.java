...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse<CategoryResponse>> createCategory(@RequestPart("categoryRequest") @Valid CategoryRequest categoryRequest,
                                                                        @RequestParam("cateImg") MultipartFile cateImg,
        ...
        ApiResponse<CategoryResponse> apiResponse = ApiResponse.<CategoryResponse>builder()
                ...
                .data(categoryService.createCategory(categoryRequest, cateImg)).build();
    ...
    public ResponseEntity<ApiResponse<CategoryResponse>> updateCategory(@PathVariable("cateId") int cateId,
                                                                        @RequestPart(value = "categoryUpdateRequest") @Valid CategoryUpdateRequest categoryUpdateRequest,
                                                                        @RequestParam(value = "cateImg", required = false) MultipartFile cateImg,
                                                                        HttpServletRequest httpServletRequest) {
        ApiResponse<CategoryResponse> apiResponse = ApiResponse.<CategoryResponse>builder()
                .code("category.update.success")
                .message(Translator.toLocale("category.update.success"))
                .data(categoryService.updateCategory(cateId, categoryUpdateRequest, cateImg)).build();
        return ResponseEntity.ok(apiResponse);
    }
