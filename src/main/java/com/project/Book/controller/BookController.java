...
public class BookController {
    ...
    public ResponseEntity<ApiResponse<BookResponse>> createBook(@RequestPart("bookRequest") BookRequest bookRequest, @RequestParam("bookImg") MultipartFile bookImg, HttpServletRequest httpServletRequest) {
        ApiResponse<BookResponse> apiResponse = ApiResponse.<BookResponse>builder()
                ...
                .data(bookService.createBook(bookRequest, bookImg)).build();
    ...
    public ResponseEntity<ApiResponse<BookResponse>> updateBook(@PathVariable("bookId") int bookId,
                                                                @RequestPart(value = "bookUpdateRequest") BookUpdateRequest bookUpdateRequest,
                                                                @RequestParam(value = "bookImg", required = false) MultipartFile bookImg,
                                                                HttpServletRequest httpServletRequest) {
        ApiResponse<BookResponse> apiResponse = ApiResponse.<BookResponse>builder()
                .code("book.update.success")
                .message(Translator.toLocale("book.update.success"))
                .data(bookService.updateBook(bookId, bookUpdateRequest, bookImg)).build();
        return ResponseEntity.ok(apiResponse);
    }
